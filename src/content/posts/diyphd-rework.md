...
- [x] [Growing Artificial Societies: Social Science from the Bottom Up](https://mitpress.mit.edu/9780262550253/growing-artificial-societies/) by Joshua Epstein and Robert L. Axtell
- [x] [Agent-Based Modeling for Archaeology: Simulating the Complexity of Societies](https://www.sfipress.org/books/agent-based-modeling-archaeology) by Iza Romanowska, Colin D. Wren, and Stefani A. Crabtree
- [ ] [Ex Machina: Coevolving Machines & the Origins of the Social Universe](https://www.sfipress.org/books/ex-machina) by John H. Miller
